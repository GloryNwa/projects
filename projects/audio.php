                      ...
                      $query = "SELECT * FROM `resources` WHERE `id` = $id" ;
                       ...
                       <div class="traffic-chart-wrp" style="background: #272c33;">
                            ...
                            <div align="center" class="embed-responsive embed-responsive-16by9">
                             <audio autoplay  class="embed-responsive-item" controls  style="width:100%border-radius: 15px;">
                               <source  src=<?php echo "ResourceUploads/" .$file." style=width:40%";?> type="audio/mp3">
                              </audio>
