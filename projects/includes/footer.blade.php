...
<footer>
  ...
  <script src="{{ URL::to("/")}}/js/slick.min.js" type="text/javascript"></script>

  <!-- Our Website Javascripts -->
  <script src="{{ URL::to("/")}}/js/isotope.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/isotope-int.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.counterup.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/waypoints.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/highcharts.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/exporting.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/highcharts-more.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/moment.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.circliful.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/fullcalendar.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.downCount.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.formtowizard.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/form-validator.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/form-validator-lang-en.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/cropbox-min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.slimscroll.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/ion.rangeSlider.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/jquery.poptrox.min.js" type="text/javascript"></script>
  <script src="{{ URL::to("/")}}/js/styleswitcher.js" type="text/javascript"></script>
